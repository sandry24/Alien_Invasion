...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.replay_button = Button(self, "Restart")
    ...
    def _create_fleet(self):
        ...
        # Create an alien and determine how many aliens fit in a row
        alien = Alien(self)
    ...
    def _update_screen(self):
        ...
        if not self.stats.game_active:
            if self.stats.first_game:
                self.screen.blit(self.settings.play_menu, (0, 0))
                self.play_button.draw_button()
            else:
                self.screen.blit(self.settings.game_over_menu, (0, 0))
